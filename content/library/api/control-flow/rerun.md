---
title: st.rerun
slug: /develop/api-reference/control-flow/st.rerun
...
In many cases where `st.rerun` works, [callbacks](/develop/api-reference/control-flow/st.session_state#use-callbacks-to-update-session-state) may be a cleaner alternative. [Containers](/develop/api-reference/layout) may also be helpful.
