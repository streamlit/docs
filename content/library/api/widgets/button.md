...
Although a button is the simplest of input widgets, it's very common for buttons to be deeply tied to the use of [`st.session_state`](/develop/api-reference/control-flow/session-state). Check out our advanced guide on [Button behavior and examples](/develop/concepts/elements-and-ui/button-behavior-and-examples).
