...
<div style={{ maxWidth: '90%', marginLeft: '3em' }}>
    <Image src="/images/api/configuration/app-menu-record-2.png" alt="Record" />
</div>
...
<div style={{ maxWidth: '90%', marginLeft: '3em' }}>
    <Image src="/images/api/configuration/app-menu-record-3.png" alt="Record" />
</div>

6. Click "**Share**."

<div style={{ maxWidth: '90%', marginLeft: '3em' }}>
    <Image src="/images/api/configuration/app-menu-record-4.png" alt="Record" />
</div>
...
<div style={{ maxWidth: '90%', marginLeft: '3em' }}>
    <Image src="/images/api/configuration/app-menu-record-5.png" alt="Record" />
</div>

8. When you are done recording, press "**Esc**" on your keyboard or click "**Stop recording**" from your app's menu.

<div style={{ maxWidth: '90%', marginLeft: '3em' }}>
    <Image src="/images/api/configuration/app-menu-record-6.png" alt="Record" />
</div>
...
Using `client.toobarMode` in your app's [configuration](http://localhost:3000/library/api-reference/configuration-and-management/configuration), you can make the app menu appear in the following ways:
