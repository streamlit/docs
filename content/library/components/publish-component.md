...
slug: /develop/components/publish
---
...
For [static Streamlit Components](/develop/components/components-api#create-a-static-component), publishing a Python package to PyPI follows the same steps as the
...
[Bi-directional Streamlit Components](/develop/components/components-api#create-a-bi-directional-component) at minimum include both Python and JavaScript code, and as such, need a bit more preparation before they can be published on PyPI. The remainder of this page focuses on the bi-directional Component preparation process.
