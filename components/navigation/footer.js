          ...
          >
            <i className={styles.IconContainer}>
              <svg
                ...
                `}
              >
                <path d="M13.537 11.828c0 3.77-3.03 6.827-6.768 6.827S0 15.598 0 11.828 3.03 5 6.769 5c3.738 0 6.768 3.057 6.768 6.828ZM20.964 11.828c0 3.55-1.515 6.428-3.384 6.428-1.87 0-3.385-2.879-3.385-6.428 0-3.55 1.515-6.428 3.384-6.428 1.87 0 3.385 2.878 3.385 6.428M24.002 11.829c0 3.179-.533 5.758-1.19 5.758-.658 0-1.19-2.578-1.19-5.758s.532-5.759 1.19-5.759c.656 0 1.19 2.578 1.19 5.759Z" />
              </svg>
            </i>
          </a>
          {/* Twitter */}
