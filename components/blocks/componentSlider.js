  ...
  return (
    <section className={styles.SectionContainer}>
      <div className={styles.TitleContainer}>
        <p className={styles.Title}>Third-party components</p>
        <button className={styles.TooltipIcon}>
          <svg
            width="16"
            height="17"
            viewBox="0 0 16 17"
        ...
        {/* Hiding custom arrows for now, using standard ones from slick for now */}
