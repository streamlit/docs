      ...
      block = (
        <section className="improve">
          ...
          <div className="input-container">
            <input
              onChange={this.handleImprovement}
              type="checkbox"
              id="moreExamples"
              name="moreExamples"
              checked={this.state.moreExamples}
            />
          ...
          <div className="input-container">
            <input
              ...
              id="clearerSteps"
              name="clearerSteps"
              checked={this.state.clearerSteps}
            />
          ...
          <div className="input-container">
            <input
              ...
              checked={this.state.moreInformation}
            />
      ...
      <section className="block-helpful">
        ...
        >
          ...
          <input
            type="hidden"
            name="improvements"
            value={this.state.improvementsString}
          />
          <input type="hidden" name="notes" value={this.state.notes} />
          {block}
        </form>
        <SuggestEdits
          sourcefile={this.props.sourcefile ? this.props.sourcefile : ""}
        />
      </section>
    );
  }
